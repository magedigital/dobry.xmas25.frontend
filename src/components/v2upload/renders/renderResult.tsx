...
const renderResult: I['renderResult'] = function () {
    ...
    return (
        <Fade className="v2upload__result _FULL _COL _COL_CENTER" isShow={!!fileName}>
            <p className="v2upload__resultName">{fileName}</p>
            <label className="v2upload__resultButton _CLICK">
