            ...
            <div className="popup__successInner _FULL _COL _COL_CENTER">
                <div className="popup__successHead _COL _COL_CENTER">
                    ...
                    <p className="popup__successText">
                        Твое предложение успешно отправлено и&nbsp;будет рассмотрено
                        в&nbsp;ближайшее время. В&nbsp;случае выигрыша мы свяжемся с тобой
                        по&nbsp;указанному email.
                    </p>
                </div>

                <div className="popup__successButton">
                    <Button className="_purple" onClick={this.close.bind(this)}>
                        ЗАкрыть окно
                    </Button>
                </div>
            </div>
