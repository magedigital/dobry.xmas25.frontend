    ...
    implements DobroPopupI
{
    ...
    items = [
        {
            count: '700+',
            title: 'подростков участвуют в программе «Растим добро» ежегодно',
        },
        {
            count: '11',
            title: 'НКО-проектов содействуют социальной адаптации подопечных программы',
        },
        {
            count: '40',
            title: 'учреждений участвуют в программе «Растим добро»',
        },
        {
            count: '12',
            title: 'регионов охватываются программой «Растим добро» ежегодно',
        },
        {
            count: '90%',
            title: 'участников отмечают, что программа помогла им после выпуска из детского дома',
        },
    ];
                                    ...
                                    <div className="collectionPopup__dobroContent">
                                        ...
                                        <div className="collectionPopup__dobroOffer _COL">
                                            ...
                                            <p className="collectionPopup__dobroOfferTitle">
                                                СДЕЛАЙ ВКЛАД <br className="_MOBILE" />В УСПЕШНОЕ
                                                БУДУЩЕЕ ВЫПУСКНИКОВ ДЕТСКИХ ДОМОВ
                                            </p>
                                            ...
                                            <div className="collectionPopup__dobroOfferInfo">
                                                Каждые <b>5 баллов</b> — это сертификат{' '}
                                                <br className="_MOBILE" />
                                                на <b>1&nbsp;занятие</b> с&nbsp;репетитором для
                                                подготовки к сдаче{' '}
                                                <b>
                                                    <span>ОГЭ и&nbsp;ЕГЭ</span>
                                                </b>
